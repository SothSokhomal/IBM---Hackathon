class Conv2dNormActivation(Module):
  ...
  __annotations__["2"] = __torch__.torch.nn.modules.activation.___torch_mangle_34.SiLU
  def forward(self: __torch__.torchvision.ops.misc.___torch_mangle_35.Conv2dNormActivation,
