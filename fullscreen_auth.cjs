  ...
  return (
    ...
    >
      ...
      <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-12">
        ...
        <div className="lg:hidden w-full h-[30vh] min-h-[260px] relative flex flex-col justify-end p-6 pb-12">
          <div
          ...
          <div className="relative z-10">
            <h1 className="text-4xl font-extrabold text-white tracking-tight leading-tight">The best app for<br />your plants.</h1>
          </div>
        </div>

        {/* RIGHT FORM PANEL - Full Height */}
        <div className="lg:col-span-7 flex flex-col justify-center px-6 py-12 md:px-16 xl:px-24 relative z-20 -mt-8 rounded-t-[2.5rem] lg:mt-0 lg:rounded-none min-h-[70vh] lg:min-h-screen" style={{ backgroundColor: 'var(--bg-card)' }}>
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="text-center lg:text-left mb-10">
              <button
                className="w-12 h-12 rounded-full flex items-center justify-center mb-8 transition-transform hover:scale-105 shadow-sm mx-auto lg:mx-0"
              ...
              <p className="text-lg mt-2.5 font-medium" style={{ color: 'var(--text-secondary)' }}>
            ...
            {/* Tab Selector Pill */}
            <div
              className="p-1.5 rounded-full flex w-full max-w-xs mx-auto lg:mx-0 mb-10 border shadow-inner"
            ...
            >
              {(['login', 'register'] as const).map(t => (
                <button
                  key={t}
                  onClick={() => setTab(t)}
                  className="flex-1 py-3 text-base font-bold rounded-full transition-all"
                  style={{
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {tab === 'register' && (
                <div className="relative group">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-14 pr-6 py-4 text-lg rounded-full border focus:outline-none focus:ring-2 transition-all font-medium"
                    style={{
                      backgroundColor: 'var(--input-bg)',
                      borderColor: 'var(--border-color)',
                      color: 'var(--text-primary)',
                      outlineColor: 'var(--btn-primary)'
                    }}
                  />
                </div>
              )}
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full pl-14 pr-12 py-4 text-lg rounded-full border focus:outline-none focus:ring-2 transition-all font-medium"
                  style={{
                    backgroundColor: 'var(--input-bg)',
                    borderColor: 'var(--border-color)',
                    color: 'var(--text-primary)',
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  required
                  className="w-full pl-14 pr-12 py-4 text-lg rounded-full border focus:outline-none focus:ring-2 transition-all font-medium tracking-widest"
                  style={{
                    backgroundColor: 'var(--input-bg)',
                    borderColor: 'var(--border-color)',
                    color: 'var(--text-primary)',
              ...
              <div className="flex items-center justify-between pt-3 pb-6">
                <label className="flex items-center gap-3 cursor-pointer group">
                  ...
                  <span className="text-base font-semibold transition-colors" style={{ color: 'var(--text-secondary)' }}>Remember Me</span>
                </label>
                <button type="button" className="text-base font-bold transition-colors hover:underline" style={{ color: 'var(--text-secondary)' }}>
                  Forget Password?
                </button>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-4.5 text-lg font-bold text-white rounded-full transition-all shadow-xl hover:shadow-2xl active:scale-[0.98] flex items-center justify-center bg-gradient-to-r"
            ...
            <div className="flex items-center justify-center gap-6">
              <button className="w-14 h-14 rounded-full border-2 flex items-center justify-center transition-transform hover:scale-105 shadow-md hover:shadow-lg" style={{ borderColor: 'var(--border-color)', backgroundColor: 'var(--input-bg)' }}>
                <span className="text-2xl font-bold" style={{ color: '#1877F2' }}>f</span>
              </button>
              <button className="w-14 h-14 rounded-full border-2 flex items-center justify-center transition-transform hover:scale-105 shadow-md hover:shadow-lg" style={{ borderColor: 'var(--border-color)', backgroundColor: 'var(--input-bg)' }}>
              ...
              <button className="w-14 h-14 rounded-full border-2 flex items-center justify-center transition-transform hover:scale-105 shadow-md hover:shadow-lg text-foreground" style={{ borderColor: 'var(--border-color)', backgroundColor: 'var(--input-bg)' }}>
                <Apple className="w-7 h-7" style={{ fill: 'currentColor' }} />
              </button>
            </div>

            {/* Footer switcher */}
            <p className="text-center text-base mt-10 font-medium" style={{ color: 'var(--text-secondary)' }}>
...
console.log("AuthModal modified to span full viewport.");
